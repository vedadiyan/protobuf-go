...
const file_internal_testprotos_testeditions_testeditions_opaque_test_import_opaque_proto_rawDesc = "" +
	...
	"\n" +
	"ImportEnum\x12\x0f\n" +
	"\vIMPORT_ZERO\x10\x00BYZOgithub.com/vedadiyan/protobuf-go/internal/testprotos/testeditions/testeditions_opaque\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
