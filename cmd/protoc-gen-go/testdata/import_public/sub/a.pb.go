...
const file_cmd_protoc_gen_go_testdata_import_public_sub_a_proto_rawDesc = "" +
	...
	"\x01E\x12\b\n" +
	"\x04ZERO\x10\x00:L\n" +
	"\x0fextension_field\x12#.goproto.protoc.import_public.sub.M\x18d \x01(\tR\x0eextensionFieldBIZGgithub.com/vedadiyan/protobuf-go/cmd/protoc-gen-go/testdata/import_public/subP\x00"
